local mod = Solution.Util.CreateModuleTable("AssetConverter-App", { "base", "fileformat", "filesystem", "meta", "enkits", "casc", "cuttlefish", "jolt", "tracyprofiler", "recastnavigation-recast", "recastnavigation-detour" })
